...
export default async function ProjectDetailPage({
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2] text-slate-900">
      <section className="relative overflow-hidden border-b border-stone-800 py-2 text-white">
        ...
        <div className="relative mx-auto flex max-w-5xl flex-col items-center px-4 py-12 text-center sm:px-6 sm:py-16 lg:px-8 lg:py-20">
          ...
          <h1 className="mt-4 max-w-4xl font-heading text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">
            {project.title}
          </h1>
          ...
          <p className="mt-2 font-heading text-2xl font-bold text-[#E6C687] sm:text-3xl">
            {project.price}
          </p>
